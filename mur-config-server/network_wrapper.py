...
# Add device-manager directory (parallel to mur_config_server) to path
...
class NetworkConfig:
    ...
    def __init__(self, config_file: str = 'mur_config_server/network_config.json'):
...
class DeviceScannerWrapper:
    ...
    def __init__(self, config: NetworkConfig, progress_callback=None):
        ...
        self.device_map_file = Path('mur_config_server/device_map.json')
